                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="homec-agent-detail__body">
                                <h3 class="homec-agent-detail__title">{{ html_decode($agent->name) }}</h3>
                                <p>{{ html_decode($agent->designation) }}</p>
                            </div>
                            <ul class="homec-agent-detail__list mg-top-30">
                                <li><img src="{{ asset('frontend/img/agent-phone.svg') }}"> <a
                                        href="tel:{{ $agent->phone }}">{{ $agent->phone }}</a></li>
                                <li><img src="{{ asset('frontend/img/agent-email.svg') }}"> <a
                                        href="mailto:{{ html_decode($agent->email) }}">{{ html_decode($agent->email)
                                        }}</a></li>
                                <li><img src="{{ asset('frontend/img/agent-location.svg') }}"> {{
                                    html_decode($agent->address) }} </li>
                            </ul>
                            <ul class="homec-agent__social homec-agent__social--inline list-none mg-top-30">
                                @if ($agent->linkedin)
                                <li><a href="{{ html_decode($agent->linkedin) }}"><i class="fab fa-linkedin-in"></i></a>
                                </li>
                                @endif
                                ...
                                @if ($agent->instagram)
                                <li><a href="{{ html_decode($agent->instagram) }}"><i class="fab fa-instagram"></i></a>
                                </li>
                                @endif

                                @if ($agent->facebook)
                                <li><a href="{{ html_decode($agent->facebook) }}"><i class="fab fa-facebook-f"></i></a>
                                </li>
                                @endif
                            </ul>
                        </div>
                                ...
                                <div class="homec-property">
                                    ...
                                    <div class="homec-property__body">
                                        ...
                                        <h3 class="homec-property__title"><a
                                                href="{{ route('property', html_decode($property_item->slug)) }}">{{
                                                html_decode($property_item->title) }}</a></h3>
                                        ...
                                        <ul class="homec-property__list homec-border-top list-none">
                                            <li><img src="{{ asset('frontend/img/room-icon2.svg') }}"
                                                    alt="total_bedroom">{{ $property_item->total_bedroom }}
                                                {{__('user.Bed')}}</li>
                                            <li><img src="{{ asset('frontend/img/bath-icon2.svg') }}"
                                                    alt="total_bathroom">{{ $property_item->total_bathroom }}
                                                {{__('user.Bath')}}</li>
                                            <li><img src="{{ asset('frontend/img/size-icon2.svg') }}"
                                                    alt="total_area">{{ html_decode($property_item->total_area) }}
                                                {{__('user.m2')}}</li>
                                        </ul>
                                    </div>
                                </div>
