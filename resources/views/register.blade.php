                            ...
                            <form class="ecom-wc__form-main p-0" action="{{ route('store-register') }}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group homec-form-input">
                                            <label
                                                class="ecom-wc__form-label mg-btm-10">{{__('user.Password')}}*</label>
                                            <div class="form-group__input">
                                ...
                                <div class="form-group form-mg-top-30">
                                    <div class="ecom-wc__button ecom-wc__button--bottom">
                                        <button class="homec-btn homec-btn__second"
                                            type="submit"><span>{{__('user.Register')}}</span></button>
                                ...
                                <div class="form-group mg-top-20">
                                    <div class="ecom-wc__bottom">
                                        <p class="ecom-wc__text">{{__('user.Already have an account ?')}} <a
                                                href="{{ route('login') }}">{{__('user.Login here')}}</a></p>
                                    </div>
                                </div>
                            </form>
                            <!-- End Sign in Form -->
