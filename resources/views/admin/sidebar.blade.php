...
<div class="main-sidebar">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
          ...
          <li class="nav-item dropdown {{ Route::is('admin.pricing-plan.*') || Route::is('admin.assign-pricing-plan') || Route::is('admin.purchase-history') || Route::is('admin.show-purchase-history') || Route::is('admin.pending-payment') ? 'active' : '' }}">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-th-large"></i><span>{{__('Section')}}</span></a>

            <ul class="dropdown-menu">

                <li class="{{ Route::is('admin.pricing-plan.*') ? 'active' : '' }}"><a class="nav-link" href="/admin/section/create">{{__('section create')}}</a></li>
                <li class="{{ Route::is('admin.pricing-plan.*') ? 'active' : '' }}"><a class="nav-link" href="/admin/category2">{{__('category')}}</a></li>
                <li class="{{ Route::is('admin.pricing-plan.*') ? 'active' : '' }}"><a class="nav-link" href="/admin/subcategory">{{__('subcategory')}}</a></li>
          ...
          <li class="nav-item dropdown {{ Route::is('admin.category.*')  || Route::is('admin.nearest-location.*') || Route::is('admin.aminity.*') || Route::is('admin.property.*') || Route::is('admin.agent-property') || Route::is('admin.agent-pending-property') || Route::is('admin.assign-slider-property') || Route::is('admin.agent-reject-property') || Route::is('admin.review-list') || Route::is('admin.show-review') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="{{ Route::is('admin.property.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.property.index') }}">{{__('admin.Own Properties')}}</a></li>
          ...
          <li class="nav-item dropdown {{ Route::is('admin.city.*') || Route::is('admin.city-import-page') || Route::is('admin.assign-homepage-city') ? 'active' : '' }}">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-map-marker-alt"></i><span>{{__('admin.Locations')}}</span></a>

            <ul class="dropdown-menu">

                <li><a class="nav-link" href="{{ route('admin.city-import-page') }}">{{__('admin.Bulk Import')}}</a></li>
