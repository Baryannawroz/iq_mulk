    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu ">
            ...
            <li
                ...
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-th-large"></i><span>{{__('user.Price Plan')}}</span></a>

                <ul class="dropdown-menu ">

                    <li class="{{ Route::is('admin.pricing-plan.*') ? 'active' : '' }} "><a class="nav-link"
                            href="{{ route('admin.pricing-plan.index') }}">{{__('user.Price Plan')}}</a></li>

                    <li class="{{ Route::is('admin.assign-pricing-plan') ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('admin.assign-pricing-plan') }}">{{__('admin.Assign Pricing Plan')}}</a></li>
                    ...
                    <li class="{{ Route::is('admin.pending-payment')  ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('admin.pending-payment') }}">{{__('admin.Pending Payment')}}</a></li>
            ...
            <li
                ...
                <a href="#" class="nav-link has-dropdown"><i class="fas far fa-building"></i><span>{{__('admin.Real
                        Estate')}}</span></a>

                <ul class="dropdown-menu">

                    <li><a class="nav-link" href="{{ route('admin.property.create') }}">{{__('admin.Create Property')}}</a></li>

                    <li class="{{ Route::is('admin.property.*') ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('admin.property.index') }}">{{__('admin.Own Properties')}}</a></li>

                    <li class="{{ Route::is('admin.agent-property') ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('admin.agent-property') }}">{{__('admin.Agent All Properties')}}</a></li>

                    <li class="{{ Route::is('admin.agent-pending-property') ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('admin.agent-pending-property') }}">{{__('admin.Awaiting for approval')}}</a>
                    </li>

                    <li class="{{ Route::is('admin.agent-reject-property') ? 'active' : '' }}"><a class="nav-link"
                    ...
                    <li class="  {{ Route::is('admin.assign-slider-property') ? 'active' : '' }}"><a
                            class="nav-link" href="{{ route('admin.assign-slider-property') }}">{{__('admin.Assign Slider Property')}}</a></li>
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ route('admin.review-list') }}">{{__('admin.Review
                            List')}}</a>
                    </li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class=""><a class="nav-link" href="{{ route('admin.city-import-page') }}">{{__('admin.Bulk
                            Import')}}</a>
                    </li>
                    ...
                    <li class="  {{ Route::is('admin.assign-homepage-city') ? 'active' : '' }}"><a
                            class="nav-link" href="{{ route('admin.assign-homepage-city') }}">{{__('admin.Assign
                            homepage city')}}</a>
                    </li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ Route::is('admin.create-agent') ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('admin.create-agent') }}">{{__('admin.Create Agent')}}</a></li>

                    <li class="{{ Route::is('admin.agent') || Route::is('admin.agent-show') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('admin.agent') }}">{{__('admin.Agent List')}}</a>
                    </li>
                </ul>
            </li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ Route::is('admin.create-customer') ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('admin.create-customer') }}">{{__('admin.Create Customer')}}</a></li>
                    ...
                    <li class="{{ Route::is('admin.pending-customer-list') ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('admin.pending-customer-list') }}">{{__('admin.Pending User')}}</a></li>
                </ul>
            </li>
             ...
             <li
                ...
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-globe"></i><span>{{__('admin.Manage
                        Website')}}</span></a>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ Route::is('admin.why-choose-us.*') ? 'active' : '' }}"><a class="nav-link"
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    <li class="{{ Route::is('admin.homepage') ? 'active' : '' }}"><a class="nav-link"
                    ...
                    <li class="{{ Route::is('admin.create-property') ? 'active' : '' }}"><a class="nav-link"
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ route('admin.email-template') }}">{{__('admin.Email
                            Template')}}</a>
                    </li>
                </ul>
            </li>
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ Route::is('admin.admin-validation-language') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('admin.admin-validation-language') }}">{{__('admin.Admin
                            Validation')}}</a>
                    </li>
                    ...
                    <li class="{{ Route::is('admin.website-validation-language') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('admin.website-validation-language') }}">{{__('admin.Frontend
                            Validation')}}</a>
                    </li>
                </ul>
            </li>
