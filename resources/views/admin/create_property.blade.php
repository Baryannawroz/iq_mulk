        ...
        <div class="section-body">
            <div class="row mt-4">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.update-create-property') }}" enctype="multipart/form-data"
                                method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="rent_title" class="form-control"
                                        value="{{ $setting->rent_title }}">
                                </div>

                                <div class="form-group">
                                    <label for="">{{__('admin.Rent description')}}</label>
                                    <textarea name="rent_description" id="" class="form-control text-area-5" cols="30"
                                        rows="10">{{ $setting->rent_description }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label for="">{{__('admin.Rent button text')}}</label>
                                    <input type="text" name="rent_btn_text" class="form-control"
                                        value="{{ $setting->rent_btn_text }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sale_title" class="form-control"
                                        value="{{ $setting->sale_title }}">
                                </div>

                                <div class="form-group">
                                    <label for="">{{__('admin.Sale description')}}</label>
                                    <textarea name="sale_description" id="" class="form-control text-area-5" cols="30"
                                        rows="10">{{ $setting->sale_description }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label for="">{{__('admin.Sale button text')}}</label>
                                    <input type="text" name="sale_btn_text" class="form-control"
                                        value="{{ $setting->sale_btn_text }}">
                                </div>
