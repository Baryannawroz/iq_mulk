...
<section class="pd-top-80 pd-btm-80">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <form action="/admin/section/update/{{$section->id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                                                    ...
                                                    <label class="homec-image-video-upload__label" for="input-video121">
                                                        ...
                                                        <span
                                                            ...
                                                            <span class="homec-primary-color">{{__('user.Choose
                                                                File')}}</span> {{__('user.to upload')}} </span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="homec-submit-form mg-top-40">
                                ...
                                <div class="homec-submit-form__inner">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="mg-top-20">
                                                <p class="homec-img-video-label mg-btm-10">{{__('user.Existing Video')}}
                                                </p>
                                                <!-- Image Input -->
                                                <div>
