                                ...
                                <table class="table table-striped" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ ++$index }}</td>
                                            <td>
                                                <a target="_blank" href="{{ route('property', $property->slug) }}">{{
                                                    html_decode($property->title) }}</a>
                                            </td>

                                            <td>
                                                <a target="_blank"
                                                    href="{{ route('admin.agent-show', $property->agent_id) }}">{{
                                                    html_decode($property->agent->name) }}</a>
                                            </td>

                                            <td>{{ $currency_icon }}{{ html_decode(number_format($property->price,0)) }}
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <span class="badge badge-success mb-1">{{__('admin.Top')}}</span>
                                                @endif

                                                @if ($property->is_top == 'enable')
                                                <span class="badge badge-primary mb-1">{{__('admin.Featured')}}</span>
                                                @endif
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:;" data-toggle="modal" data-target="#deleteModal"
                                                    ...
                                                    onclick="deleteData({{ $property->id }})"><i class="fa fa-trash"
                                                        aria-hidden="true"></i></a>
                                            </td>
