...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <a href="{{ route('admin.pricing-plan.index') }}" class="btn btn-primary"><i class="fas fa-list"></i>
                {{__('user.Price Plan')}}</a>
            <div class="row mt-4">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Plan Type')}} <span
                                                    class="text-danger">*</span></label>
                                            <select name="plan_type" id="plan_type" class="form-control">
                                                <option {{ $item->plan_type == 'premium' ? 'selected' : '' }}
                                                    value="premium">{{__('admin.Premium')}}</option>
                                                <option {{ $item->plan_type == 'free' ? 'selected' : '' }}
                                                    value="free">{{__('admin.Free')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Plan Price')}} <span
                                                    class="text-danger">*</span></label>
                                            <input value="{{ $item->plan_price }}" type="text" name="plan_price"
                                                id="plan_price" class="form-control">
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Plan Price')}} <span
                                                    class="text-danger">*</span></label>
                                            <input value="{{ $item->plan_price }}" type="text" name="plan_price"
                                                id="plan_price" class="form-control" readonly>
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Plan Name')}} <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Expiration')}} <span
                                                    class="text-danger">*</span></label>
                                            <select name="expired_time" id="" class="form-control">
                                                <option {{ $item->expired_time == 'monthly' ? 'selected' : '' }}
                                                    value="monthly">{{__('admin.Monthly')}}</option>
                                                <option {{ $item->expired_time == 'yearly' ? 'selected' : '' }}
                                                    value="yearly">{{__('admin.Yearly')}}</option>
                                                <option {{ $item->expired_time == 'limetime' ? 'selected' : '' }}
                                                    value="lifetime">{{__('admin.Lifetime')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Number of property')}} <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" name="number_of_property" class="form-control"
                                                value="{{ $item->number_of_property }}">
                                        </div>
                                    </div>

                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Featured Property')}} <span
                                                    class="text-danger">*</span></label>
                                            <select name="featured_property" id="featured_property"
                                                class="form-control">
                                                <option {{ $item->featured_property == 'enable' ? 'selected' : '' }}
                                                    value="enable">{{__('admin.Enable')}}</option>
                                                <option {{ $item->featured_property == 'disable' ? 'selected' : '' }}
                                                    value="disable">{{__('admin.Disable')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6" id="featured_property_qty">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Number of featured property')}} <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" name="featured_property_qty" class="form-control"
                                                value="{{ $item->featured_property_qty }}">
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Top Property')}} <span
                                                    class="text-danger">*</span></label>
                                            <select name="top_property" id="top_property" class="form-control">
                                                <option {{ $item->top_property == 'enable' ? 'selected' : '' }}
                                                    value="enable">{{__('admin.Enable')}}</option>
                                                <option {{ $item->top_property == 'disable' ? 'selected' : '' }}
                                                    value="disable">{{__('admin.Disable')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6" id="top_property_qty">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Number of top property')}} <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" name="top_property_qty" class="form-control"
                                                value="{{ $item->top_property_qty }}">
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Urgent Property')}} <span
                                                    class="text-danger">*</span></label>
                                            <select name="urgent_property" id="urgent_property" class="form-control">
                                                <option {{ $item->urgent_property == 'enable' ? 'selected' : '' }}
                                                    value="enable">{{__('admin.Enable')}}</option>
                                                <option {{ $item->urgent_property == 'disable' ? 'selected' : '' }}
                                                    value="disable">{{__('admin.Disable')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6" id="urgent_property_qty">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Number of urgent property')}} <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" name="urgent_property_qty" class="form-control"
                                                value="{{ $item->urgent_property_qty }}">
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Serial')}} <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="" class="form-control">
                                                <option {{ $item->status == 'enable' ? 'selected' : '' }}
                                                    value="enable">{{__('admin.Enable')}}</option>
                                                <option {{ $item->status == 'disable' ? 'selected' : '' }}
                                                    value="disable">{{__('admin.Disable')}}</option>
                                            </select>
                                        </div>
                                    </div>
