...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body property_box">
            ...
            <form id="property_form" action="/admin/category2/update" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="card">
                            <div class="card-body" data-select2-id="select2-data-46-mub9">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" id="title" value="{{ $cat->name }}">
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="">{{__('admin.Description')}} </label>
                                        <textarea name="description" class="form-control text-area-5" id=""
                                            cols="30" rows="10">{{ $cat->description }}</textarea>
                                    </div>
                                </div>
                ...
                <div class="col-12">
                    <input type="number" hidden name="id" value="{{ $cat->id }}">
