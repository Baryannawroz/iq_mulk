                ...
                <div class="homec-property-bar">
                    <div class="homec-property-bar__single first">
                        <div class="homec-form__form homec-form__form--bar">
                            ...
                            <button id="searchPropertyBtn" type="button" class="homec-btn"><span>{{__('user.Search
                                    Now')}}</span></button>
                        </div>
                        <!-- Show Results -->
                        <div class="hoemc-showing-results">
                            <p class="hoemc-showing-results__text">{{__('user.You can see list or grid view from right
                                side')}}</p>
                        </div>
                        <!-- End Show Results -->
                    </div>
