            ...
            <div class="col-12">
                <div class="breadcrumb-content">
                    <ul class="breadcrumb__menu list-none">
                        ...
                        <li class="active"><a href="/sections/1">{{__('user.Section')}}</a></li>
                    </ul>
                                        ...
                                        <div class="tab-pane fade show active" id="homec-pd-tab1" role="tabpanel">
                                            <div class="homec-pdetails-tab__inner fw-bold">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class=" col-md-6 col-12 homec-ptdetails-features mg-top-30">
                                                        <h4 class="homec-ptdetails-features__title">
                                                            {{__('user.phone')}}</h4>
                                                        <a class="btn homec-btn btn-md"
                                                    ...
                                                    <div class="col-md-6 col-12 homec-ptdetails-features mg-top-30">
                                                        ...
                                                        <a class="btn homec-btn btn-md bg-primary"
                                                            href="/{{ $section->file }}">{{ __('user.section file')
                                                            }}</a>
                                                    </div>
                                                    @endif
                                                </div>
                                                <div class="row mg-top-20">
                                                    ...
                                                    <div class="col-1">
                                                        ...
                                                        <a style="cursor: pointer;" id="facebook-share-btn"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="32"
                                                                height="32" fill="currentColor" class="bi bi-facebook"
                                                                viewBox="0 0 16 16">
                                                                <path
                                                    ...
                                                    <div class="col-1">
                                                        ...
                                                        <a style="cursor: pointer;" id="instagram-share-btn"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="32"
                                                                height="32" fill="currentColor" class="bi bi-instagram"
                                                                viewBox="0 0 16 16">
                                                                <path
