                        ...
                        <div class="homec-submit-form">
                            ...
                            <div class="homec-submit-form__inner">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="mg-top-20">
                                            ...
                                            <div class="form-group homec-form-input">
                                                <input type="text" name="name" id="title" value="{{ html_decode($section->name) }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                ...
                                <div class="mg-top-20">
                                    ...
                                    <div class="form-group homec-form-input">
                                        <textarea name="description" id="ckdesc1" class="">{{ html_decode($section->description) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="mg-top-20">
                                            ...
                                            <!-- Image Input -->
                                            <div class="homec-image-video-upload homec-border homec-bg-cover" style="background-image: url({{ asset($section->image) }});">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="mg-top-20">
                                            ...
                                            <div>
                                                <iframe width="300" height="150"
                                                    src="https://www.youtube.com/embed/{{ html_decode($section->video_id) }}">
                                                </iframe>
                                            </div>
                                        </div>
                                        <!-- Single Form Element -->
                                        <div class="mg-top-20">
                                            ...
                                            <div class="form-group homec-form-input">
                                                <input type="text" name="video_id" value="{{ html_decode($section->video_id) }}">
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="mg-top-20">
                                            ...
                                            <div class="form-group homec-form-input">
                                                <select  name="city_id" class="homec-form-select homec-border select2">
                                                    ...
                                                    <option {{ $section->city_id == $city->id ? 'selected' : '' }} value="{{ $city->id }}">{{ $city->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        ...
                                        <div class="mg-top-20">
                                            ...
                                            <div class="form-group homec-form-input">
                                                <input type="text" name="address" value="{{ html_decode($section->address) }}">
                                            </div>
                                        </div>
                                    </div>
