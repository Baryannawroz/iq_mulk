                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="homec-dashboard__single">
                                            ...
                                            <div class="homec-dashboard__label">{{__('user.Total reklam')}}</div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <!-- Homec Dashboard Single -->
                                        <a href="/user/choose-property-type">
                                            <div class="homec-dashboard__single">
                                                <!-- Dashboard Icon -->
                                                <div class="homec-dashboard__icon">
                                                    <img src="{{ asset('frontend/img/dash-icon3.svg') }}">
                                                </div>
                                                <div class="homec-dashboard__label">{{__('user.Create property')}}</div>
                                                <div class="homec-dashboard__title"> &nbsp;</div>
                                            </div>
