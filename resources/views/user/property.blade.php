                                ...
                                <div class="homec-dashboard-property mg-top-30">
                                    ...
                                    <div class="homec-dashboard-property__img">
                                        ...
                                        <div class="homec-dashboard-property__content">
                                            ...
                                            <h3 class="homec-dashboard-property__title">{{ html_decode($property->title)
                                                }}</h3>
                                            ...
                                            <div class="homec-dashboard-property__rating">
                                                ...
                                                if($intAverage < $average && $average < $nextValue){
                                                    $reviewPoint=$intAverage + 0.5; $halfReview=true; } } @endphp <ul
                                                    class="homec-rating list-none d-none">
                                                    @if ($reviewQty > 0)

                                                    @for ($i = 1; $i <=5; $i++) @if ($i <=$reviewPoint) <li><i
                                                        ...
                                                        <span class="d-none">({{ $property->totalRating }}
                                                            {{__('user.ratings')}})</span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Property Button -->
                                    <div class="homec-dashboard-property__buttons">
                                        <a href="{{ route('property', $property->slug) }}"
                                            class="homec-dashboard-property__btn"><svg width="23" height="14"
                                                viewBox="0 0 23 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M11.6793 0.0471191C7.48656 0.0471191 3.68437 2.341 0.878736 6.06688C0.649796 6.37213 0.649796 6.79859 0.878736 7.10384C3.68437 10.8342 7.48656 13.1281 11.6793 13.1281C15.872 13.1281 19.6742 10.8342 22.4799 7.10833C22.7088 6.80308 22.7088 6.37662 22.4799 6.07137C19.6742 2.341 15.872 0.0471191 11.6793 0.0471191ZM11.9801 11.1933C9.19687 11.3684 6.8985 9.07452 7.07357 6.28684C7.21722 3.98847 9.08016 2.12553 11.3785 1.98188C14.1617 1.80681 16.4601 4.10069 16.285 6.88837C16.1369 9.18225 14.2739 11.0452 11.9801 11.1933ZM11.8409 9.06554C10.3416 9.15981 9.1026 7.92533 9.20136 6.426C9.27767 5.18704 10.2832 4.18599 11.5222 4.10518C13.0215 4.01091 14.2605 5.24539 14.1617 6.74472C14.0809 7.98818 13.0754 8.98923 11.8409 9.06554Z" />
                                            </svg>
                                        </a>
                                        <a href="{{ route('user.property.edit', $property->id) }}"
                                            class="homec-dashboard-property__btn  homec-dashboard-property__btn--edit"><svg
                                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M11.5401 12.732C11.3622 12.9097 11.1425 13.0456 10.9043 13.125L8.6037 13.8918C8.43767 13.9472 8.26451 13.9753 8.08933 13.9753C7.65479 13.9753 7.24626 13.8061 6.93903 13.4988C6.50051 13.0602 6.34998 12.4224 6.54609 11.8341L7.31296 9.53366C7.39231 9.2954 7.52823 9.07547 7.7059 8.8978L12.6748 3.92896H2.95305C1.85675 3.92896 0.964844 4.82086 0.964844 5.91716V17.4849C0.964844 18.5812 1.85675 19.4731 2.95305 19.4731H14.5208C15.6171 19.4731 16.509 18.5812 16.509 17.4849V7.76315L11.5401 12.732Z" />
                                                <path
                                                    d="M8.47256 9.66509C8.41302 9.72463 8.3682 9.79718 8.34159 9.87704L7.57472 12.1775C7.50976 12.3724 7.56048 12.5872 7.70569 12.7324C7.85094 12.8777 8.06574 12.9284 8.26058 12.8634L10.5611 12.0966C10.641 12.07 10.7135 12.0251 10.7731 11.9656L17.5468 5.19185L15.2463 2.89136L8.47256 9.66509Z" />
                                                <path
                                                    d="M18.1844 1.22954C17.8315 0.876613 17.2593 0.876613 16.9064 1.22954L16.0117 2.12419L18.3123 4.42472L19.2069 3.53007C19.5598 3.17714 19.5598 2.60494 19.2069 2.25202L18.1844 1.22954Z" />
                                            </svg>
                                        </a>
                                        <a href="javascript:;" onclick="deleteProperty({{ $property->id }})"
                                            class="homec-dashboard-property__btn homec-dashboard-property__btn--delete"><svg
                                        ...
                                        <form class="d-none"
                                            action="{{ route('user.property.destroy', $property->id) }}" method="POST"
                                            id="remove_property-{{ $property->id }}">
                                            @csrf
                                            @method('DELETE')
                                ...
                                <div class="homec-dashboard-property mg-top-30">
                                    ...
                                    <div class="homec-dashboard-property__img">
                                        ...
                                        <div class="homec-dashboard-property__content">
                                            ...
                                            <h3 class="homec-dashboard-property__title">{{ html_decode($section->name)
                                                }}</h3>
                                            <div class="homec-property__text">
                                                <img src="{{ asset('frontend/img/location-icon.svg') }}">
                                    ...
                                    <!-- Property Button -->
                                    <div class="homec-dashboard-property__buttons">
                                        <a href="/section/{{ $section->id }}" class="homec-dashboard-property__btn"><svg
                                                width="23" height="14" viewBox="0 0 23 14" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M11.6793 0.0471191C7.48656 0.0471191 3.68437 2.341 0.878736 6.06688C0.649796 6.37213 0.649796 6.79859 0.878736 7.10384C3.68437 10.8342 7.48656 13.1281 11.6793 13.1281C15.872 13.1281 19.6742 10.8342 22.4799 7.10833C22.7088 6.80308 22.7088 6.37662 22.4799 6.07137C19.6742 2.341 15.872 0.0471191 11.6793 0.0471191ZM11.9801 11.1933C9.19687 11.3684 6.8985 9.07452 7.07357 6.28684C7.21722 3.98847 9.08016 2.12553 11.3785 1.98188C14.1617 1.80681 16.4601 4.10069 16.285 6.88837C16.1369 9.18225 14.2739 11.0452 11.9801 11.1933ZM11.8409 9.06554C10.3416 9.15981 9.1026 7.92533 9.20136 6.426C9.27767 5.18704 10.2832 4.18599 11.5222 4.10518C13.0215 4.01091 14.2605 5.24539 14.1617 6.74472C14.0809 7.98818 13.0754 8.98923 11.8409 9.06554Z" />
                                            </svg>
                                        ...
                                        <a href="javascript:;" onclick="deleteSection({{ $section->id }})"
                                            class="homec-dashboard-property__btn homec-dashboard-property__btn--delete"><svg
                                                width="16" height="21" viewBox="0 0 16 21" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        <form class="d-none" action="/section/{{$section->id }}/delete" method="POST"
                                            id="remove_section-{{ $section->id }}">
                                            @csrf
