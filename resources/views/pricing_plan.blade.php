@extends('layout')
@section('title')
<title>{{__('user.Price Plan')}}</title>
@endsection
@section('meta')
<meta name="title" content="{{__('user.Price Plan')}}">
<meta name="description" content="{{__('user.Price Plan')}}">
@endsection
            ...
            <div class="col-12">
                <div class="breadcrumb-content">
                    <ul class="breadcrumb__menu list-none">
                        ...
                        <li class="active"><a href="{{ route('pricing-plan') }}">{{__('user.Price Plan')}}</a></li>
                    </ul>
                    <h2 class="breadcrumb__title m-0">{{__('user.Price Plan')}}</h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="homec-psingle {{ ++$index % 2 == 0 ? 'homec-psingle__active' : '' }} ">
                    ...
                    <div class="homec-psingle__body">
                        <ul class="homec-psingle__list">
                            ...
                            @else
                            <li><span class="homec-psingle__icon homec-check-color"><i
                                        class="fas fa-check"></i></span>{{ $pricing_plan->number_of_property }}
                            ...
                            @else
                            <li><span class="homec-psingle__icon homec-check-color"><i
                                        class="fas fa-check"></i></span>{{ $pricing_plan->featured_property_qty }}
                            ...
                            @else
                            <li><span class="homec-psingle__icon homec-check-color"><i
                                        class="fas fa-check"></i></span>{{ $pricing_plan->top_property_qty }}
                            ...
                            @else
                            <li><span class="homec-psingle__icon homec-check-color"><i
                                        class="fas fa-check"></i></span>{{ $pricing_plan->urgent_property_qty }}
                        ...
                        <div class="homec-psingle__button">
                            ...
                            <a href="{{ route('free-enroll', $pricing_plan->plan_slug) }}"
                                class="homec-btn homec-btn__thrid"><span>{{__('user.Trail Now')}}</span></a>
                            @else
                            <a href="{{ route('payment', $pricing_plan->plan_slug) }}"
