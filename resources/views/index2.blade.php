                                        ...
                                        <div class="homec-psingle {{ ++$index % 2 == 0 ? 'homec-psingle__active' : '' }} ">
                                            ...
                                            <div class="homec-psingle__body">
                                                <ul class="homec-psingle__list">
                                                    ...
                                                    <li><span class="homec-psingle__icon homec-check-color"><i class="fas fa-check"></i></span>{{__('user.Property Plan')}}</li>

                                                    <li><span class="homec-psingle__icon homec-check-color"><i class="fas fa-check"></i></span>{{__('user.Additional Information')}}</li>

                                                    <li><span class="homec-psingle__icon homec-check-color"><i class="fas fa-check"></i></span>{{__('user.Image Gallery')}}</li>
